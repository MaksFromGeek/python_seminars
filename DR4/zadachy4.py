...
# вводит 2 числа. n - кол-во элементов первого множества. m - кол-во элементов второго множества. Затем 
...
# n, m = map(int, input('Введите ч/з пробел количество элементов 1 и 2 множеств: ').split())
# a = set(map(int, input('Введите ч/з пробел элементы 1 множества: ').split()))
# b = set(map(int, input('Введите ч/з пробел элементы 2 множества: ').split()))
# print(*sorted(a & b))
